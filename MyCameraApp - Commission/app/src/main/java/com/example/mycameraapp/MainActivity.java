...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int STORAGE_PERM_CODE = 103;
    private String currentPhotoPath;
    private Uri imageUri;

    // ImageButtons
    private ImageButton cameraBtn, galleryBtn, messagesBtn, contactsBtn, facebookBtn, youtubeBtn;
